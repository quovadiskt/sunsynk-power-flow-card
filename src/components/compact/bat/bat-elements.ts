			...
			<g>
				...
				>
					...
					${renderText(
						...
						compactMode ? 270 : !entities?.battery_status ? 193 : 169,
						compactMode ? 338 : 323,
						!config.battery.show_remaining_energy ||
							(compactMode && batteryCount === 2),
						!entities?.battery_status && !compactMode
							? 'remaining-energy'
				...
				>
					...
					${createTextWithPopup(
						...
						193,
						386,
						entities.battery2_power_190 === 'none' || !config.show_battery,
						`${largeFont !== true ? 'st14' : 'st4'} st8`,
						battery2Colour,
						config.battery2.auto_scale
							? `${
					...
					${renderText(
						'battery2_remaining_energy',
						!entities?.battery2_status ? 193 : 169,
						323,
